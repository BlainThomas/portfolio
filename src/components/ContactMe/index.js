const contactLinks = [
  {
    ...
    link: 'mailto:BlainThomas12@gmail.com',
  },
  {
    name: 'GitHub',
    icon: 'fa-brands fa-github',
    link: 'https://github.com/BlainThomas',
  },
  {
    name: 'LinkedIn',
    icon: 'fa-brands fa-linkedin',
    link: 'https://www.linkedin.com/in/blain-thomas/',
  },
];
              ...
              <a href={link.link} target='_blank' rel='noreferrer'>
                ...
                >
                  <div className='px-4 py-5 flex-auto'>
                    <div className='text-white p-3 text-center inline-flex items-center justify-center w-14 h-14 mb-5 shadow rounded-full bg-blue-400 border border-slate-300'>
